...
#include "SolenoidClick.h"
     ...
     */
    SolenoidClick::SolenoidClick(int toggler, Joystick joystickName, Solenoid solenoid1, Solenoid solenoid2, string inputType) {
        this->running = true;
     ...
     */
    SolenoidClick::SolenoidClick(int toggler, Joystick &joystickName, Solenoid &solenoid1, Solenoid &solenoid2, string inputType, double highMargin, double lowMargin) {
        this->running = true;
        this->toggler = toggler;
        this->joystickName = joystickName;
        this->solenoid1 = solenoid1;
     ...
     * @param solenoid2 The second solenoid.
     */
   SolenoidClick::SolenoidClick(DigitalInput &switch1, Solenoid &solenoid1, Solenoid &solenoid2) {
        this->running = true;
     ...
     * @param inputType Axis or Button?
     */
    SolenoidClick::SolenoidClick(int toggler, ExecutiveOrder &control, Solenoid &solenoid1, Solenoid &solenoid2, string inputType){
        this->running = true;
        this->toggler = toggler;
